...
enum SamplePhotoLibrary {
    ...
    private static let manifest: [(filename: String, zhTitle: String, enTitle: String, zhSubtitle: String, enSubtitle: String)] = [
        ...
        ("swiss-scene-01.png", "瑞士街景 01", "Swiss Scene 01", "PP4AV 瑞士 · 远距离小车牌", "PP4AV Switzerland · distant small plate"),
        ("swiss-scene-02.png", "瑞士街景 02", "Swiss Scene 02", "PP4AV 瑞士 · 多车混行", "PP4AV Switzerland · multi-car traffic"),
        ("swiss-scene-03.png", "瑞士街景 03", "Swiss Scene 03", "PP4AV 瑞士 · 路边抓拍", "PP4AV Switzerland · roadside capture"),
        ("swiss-scene-04.png", "瑞士街景 04", "Swiss Scene 04", "PP4AV 瑞士 · 复杂城市背景", "PP4AV Switzerland · complex urban background"),
